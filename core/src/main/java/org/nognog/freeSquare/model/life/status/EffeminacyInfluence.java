 ...
 */
public class EffeminacyInfluence extends StatusInfluence {

	/**
	 * @param influencePerAmount
	 */
	public EffeminacyInfluence(double influencePerAmount) {
		super(influencePerAmount);
	}

	@Override
	public void applyTo(Status targetStatus, int amount) {
		targetStatus.addEffeminacy(amount * this.getInfluencePerAmount());
	}
}
